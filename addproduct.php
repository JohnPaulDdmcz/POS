...
$result->execute(); // No need for bindParam since no placeholders are used

// Fetching data and outputting as options
while ($row = $result->fetch()) {
    echo '<option>' . htmlspecialchars($row['suplier_name']) . '</option>';
}
?>
